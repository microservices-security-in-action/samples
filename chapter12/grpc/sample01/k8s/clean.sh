...
kubectl delete virtualservices ecomm-virtual-service orders-virtual-service sts-virtual-service orders-virtual-service
...
kubectl delete authorizationpolicy orders-services-policy inventory-services-policy
