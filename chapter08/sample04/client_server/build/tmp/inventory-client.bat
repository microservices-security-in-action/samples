...
@rem ##########################################################################
@rem
@rem  inventory-client startup script for Windows
@rem
@rem ##########################################################################
...
@rem Add default JVM options here. You can also use JAVA_OPTS and INVENTORY_CLIENT_OPTS to pass JVM options to this script.
...
@rem Execute inventory-client
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %INVENTORY_CLIENT_OPTS%  -classpath "%CLASSPATH%" com.manning.mss.ch08.sample04.InventoryClient %CMD_LINE_ARGS%
...
:fail
rem Set variable INVENTORY_CLIENT_EXIT_CONSOLE if you need the _script_ return code instead of
rem the _cmd.exe /c_ return code!
if  not "" == "%INVENTORY_CLIENT_EXIT_CONSOLE%" exit 1
exit /b 1
