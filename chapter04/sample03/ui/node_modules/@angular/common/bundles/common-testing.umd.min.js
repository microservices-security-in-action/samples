...
/**
     ...
     * Use of this source code is governed by an MIT-style license that can be
     * found in the LICENSE file at https://angular.io/license
     */((function(){return t.hashUpdate.next({type:"hashchange",state:null,oldUrl:e,newUrl:t.url})}))},t.prototype.getState=function(){return this.state},h([e.Injectable(),i(0,e.Inject(g)),i(0,e.Optional()),a("design:paramtypes",[Object])],t)}();t.MOCK_PLATFORM_LOCATION_CONFIG=g,t.MockLocationStrategy=c,t.MockPlatformLocation=y,t.SpyLocation=p,Object.defineProperty(t,"__esModule",{value:!0})}));