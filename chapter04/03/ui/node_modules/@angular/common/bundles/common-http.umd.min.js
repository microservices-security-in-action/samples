...
/**
     ...
     * found in the LICENSE file at https://angular.io/license
     */
e.HTTP_INTERCEPTORS=N,e.HttpBackend=a,e.HttpClient=x,e.HttpClientJsonpModule=W,e.HttpClientModule=V,e.HttpClientXsrfModule=X,e.HttpErrorResponse=k,e.HttpHandler=s,e.HttpHeaderResponse=j,e.HttpHeaders=h,e.HttpParams=m,e.HttpRequest=T,e.HttpResponse=C,e.HttpResponseBase=E,e.HttpUrlEncodingCodec=f,e.HttpXhrBackend=U,e.HttpXsrfTokenExtractor=q,e.JsonpClientBackend=S,e.JsonpInterceptor=I,e.XhrFactory=L,e.ɵHttpInterceptingHandler=D,e.ɵangular_packages_common_http_http_a=P,e.ɵangular_packages_common_http_http_b=R,e.ɵangular_packages_common_http_http_c=K,e.ɵangular_packages_common_http_http_d=z,e.ɵangular_packages_common_http_http_e=M,e.ɵangular_packages_common_http_http_f=F,e.ɵangular_packages_common_http_http_g=J,e.ɵangular_packages_common_http_http_h=B,Object.defineProperty(e,"__esModule",{value:!0})}));