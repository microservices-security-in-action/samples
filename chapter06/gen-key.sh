...
openssl x509 -req -passin pass:"manning123" -days 365 -in /export/inventory/csr-for-app -CA /export/ca/ca_cert.pem -CAkey /export/ca/ca_key.pem -set_serial 01 -out /export/inventory/app_cert.pem
